...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ps04-inventory-qualification) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")))))
(require rackunit)
...
(define book-1 (make-book 15 "How to Design Programs" "Felleisen et al." 
                          "MIT Press" 59 49 100 reorder-status-1 1/12))
...
(define-test-suite inventory-tests
  ...
  (check-provided (inventory-after-deliveries inventory-1)))  
