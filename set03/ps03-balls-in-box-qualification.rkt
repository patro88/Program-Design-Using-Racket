...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ps03-balls-in-box-qualification) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require rackunit)
