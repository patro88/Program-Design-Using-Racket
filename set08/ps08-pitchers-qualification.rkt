...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ps08-pitchers-qualification) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t write repeating-decimal #f #t none #f ())))
(require rackunit)
(require "extras.rkt")
